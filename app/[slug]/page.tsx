...
export default function IndexSlugPage({ params }: { params: { p: string } }) {
    return (
...
export async function generateStaticParams() {
    // Define the dynamic routes you want to generate
    return [
        { slug: 'p=animated-circular-navigation' },
        { slug: 'p=animated-navigation' },
        { slug: 'p=animated-keyboard' },
        { slug: 'p=overlay' },
        { slug: 'p=data-table' },
        { slug: 'p=tabs' },
